...
(function($) {
     ...
     * @constructor
     */
    function MailingForm(element, options) {
        this.element = $(element);
        this.formElements = {};
        this._idCounter = 0;
        options = options || {};
        options.url = options.url || Config.dashboardAPI + '/mailchimp/subscribe';
        options.redirect = options.redirect || false;
        options.trackUrl = options.trackUrl || '/forms/mailing';
    ...
    MailingForm.prototype.getUniqueId = function(prefix) {
        return 'signup-form-' + prefix + '-' + this._idCounter++;
    };

    MailingForm.prototype.clearErrors = function() {
     ...
     * @param data
     */
    MailingForm.prototype.displayError = function(err, data) {
     ...
     * @param message
     */
    MailingForm.prototype.displaySuccess = function(message) {
        this._errorAlertElement.hide();
     ...
     */
    MailingForm.prototype.startProgress = function() {
     ...
     */
    MailingForm.prototype.stopProgress = function() {
     ...
     * @private
     */
    MailingForm.prototype._validateField = function(field, value) {
     ...
     * @private
     */
    MailingForm.prototype._validateForm = function(done) {
        var valid = true;
        var errors = {};
        var data = {};
     ...
     * @private
     */
    MailingForm.prototype._buildForm = function() {
        $.each(this.formData.fields, function(index, field) {
     ...
     * @private
     */
    MailingForm.prototype._trackSuccess = function() {
     ...
     * @param event
     */
    MailingForm.prototype.onSubmit = function(event) {
    ...
    window.MailingForm = MailingForm;
